...
<body>
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 b2" id="grad" style="padding-bottom:13%;">
<div class="col-md-6 col-md-offset-3 white b1" style="padding:2% 5% 5% 5%;margin-top:13%">
<h3 style="padding-bottom:2%"><center>Welcome ADMIN!!</center></h3>
<form id="loginform">
...
<div class="form-group" style="padding:2% 0%">
  ...
  <button href="" class="btn btn-default blue login cwhite w100">Login</button>
  </form>
  </div>
  </div>
...
</html><?php /**PATH C:\Users\HP\medcare\resources\views/back-end/admin.blade.php ENDPATH**/ ?>