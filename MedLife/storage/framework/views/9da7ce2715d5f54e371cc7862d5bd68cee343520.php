...
<option><?php echo e($p->name); ?></option>
...
<tbody>
<?php $__currentLoopData = $data['doctorloop']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<tr>
<td><?php echo e($p->spname); ?></td>
<td><?php echo e($p->name); ?></td>
<td><img src="<?php echo e($p->image); ?>" width="40" ></td>
<td><?php echo e($p->description); ?></td>
<td><button type="button" class="btn btn-primary btn-lg" id="doctoredit" name="doctoredit" onclick="editDoctor(<?php echo e($p->doctor_id); ?>) "><img src="back-end/Image/pen1.png" width="20"/></button>
<button type="button" class="btn btn-danger btn-lg" id="doctordelete" name="doctordelete" onclick="deleteDoctor(<?php echo e($p->doctor_id); ?>) "><img src="back-end/Image/delete.png" width="16"/></button></td>
</tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</tbody>
</table>
...
</html><?php /**PATH C:\Users\HP\medcare\resources\views/back-end/doctorsb.blade.php ENDPATH**/ ?>