...
<input type="hidden" name="pid" id="pid" value="<?php echo e($data['uid']); ?>">
...
<input type="text" class="form-control register_pad" name="bookingspeciality" id="bookingspeciality" value="<?php echo e($data['doctorloop']->spname); ?> "></div>
<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
<label for="bookingdoctor">Doctor's Name</label>
<input type="text" class="form-control register_pad" name="bookingdoctor" id="bookingdoctor" value="<?php echo e($data['doctorloop']->name); ?> "></div>
<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
...
</html><?php /**PATH C:\Users\HP\medcare\resources\views/front-end/booking.blade.php ENDPATH**/ ?>