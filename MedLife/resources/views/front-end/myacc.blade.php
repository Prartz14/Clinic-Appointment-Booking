...
<input type="hidden" name="profile_id" id="profile_id" value="{{$data['profileloop']->id}}">
<input type="hidden" name="_token" id="token2" value="{{ csrf_token() }}">
<label for="profilefname">First Name</label>
<input type="text" class="form-control" value="{{$data['profileloop']->firstname}}" name="profilefname" id="profilefname" style="margin-bottom:3%">
<label for="profilelname">Last Name</label>
<input type="text" class="form-control" value="{{$data['profileloop']->lastname}}" name="profilelname" id="profilelname" style="margin-bottom:3%">
<label for="profilegender">Gender</label>
<select class="form-control register_pad " id="profilegender" name="profilegender">
<option value="{{$data['profileloop']->gender}}">Select Gender</option>
<option>Male</option>
...
<input type="text" class="form-control" value="{{$data['profileloop']->email}}" name="profileemail" id="profileemail" style="margin-bottom:3%">
<label for="profilecontact">Contact</label>
<input type="text" class="form-control" value="{{$data['profileloop']->contact}}" name="profilecontact" id="profilecontact" style="margin-bottom:3%">
<label for="profiledob">Date of Birth</label>
<input type="date" class="form-control" value="{{$data['profileloop']->dob}}" name="profiledob" id="profiledob" style="margin-bottom:3%">
