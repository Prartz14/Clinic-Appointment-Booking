...
<td>{{$p->description}}</td>
<td><button type="button" class="btn btn-primary btn-lg" id="specialityedit" name="specialityedit" onclick="editSpeciality({{$p->speciality_id}})"><img src="back-end/Image/pen1.png" width="20"/></button>
<button type="button" class="btn btn-danger btn-lg" id="specialitydelete" name="specialitydelete" onclick="deleteSpeciality({{$p->speciality_id}})" ><img src="back-end/Image/delete.png" width="16"/></button></td>
</tr>
@endforeach
</tbody>
</table>
