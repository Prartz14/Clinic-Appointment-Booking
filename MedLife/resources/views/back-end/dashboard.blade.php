...
<p style="color:black;font-weight:900;font-size:25px">{{$data['speccount']}}</p>
<p style="color:grey">Specialities</p>
</div>
<div class="col-md-3  col-lg-3 col-sm-12 col-xs-12 white" style="padding:3%;margin-bottom:4%;margin-right:4%">
<p style="color:black;font-weight:900;font-size:25px">{{$data['doccount']}}</p>
...
<p style="color:black;font-weight:900;font-size:25px">{{$data['bookcount']}}</p>
